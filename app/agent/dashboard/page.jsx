...
//           <button onClick={clearFilters} className="text-red-400 underline ml-2 text-sm hover:text-red-300">
//             Clear Filters ✖
//           </button>
//         )}
...
//                   <button onClick={()=>handleAISummary(t)} className="bg-blue-600 px-2 rounded text-xs">
//                     {aiLoadingId===t._id ? "..." : "🧠"}
//                   </button>

//                   <button onClick={()=>handleAIReply(t._id)} className="bg-green-600 px-2 rounded text-xs">
//                     Reply
//                   </button>
//                 </td>
